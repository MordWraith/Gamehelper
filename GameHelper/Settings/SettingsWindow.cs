...
namespace GameHelper.Settings
{
    ...
    internal static class SettingsWindow
    {
        ...
        private static void DrawPluginManager()
        {
            ...
            ImGui.TableSetupColumn(L.T("settings.plugin.column.plugin", "Plugin"), ImGuiTableColumnFlags.WidthStretch, 0.7f);
        ...
        private static void DrawCoreSettings()
        {
            ...
            ImGui.TextColored(color, L.T("settings.about.version", "For PoE2 0.5.4"));
